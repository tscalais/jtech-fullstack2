            ...
            <div class="flex-1 overflow-y-auto px-6 py-4 space-y-6">
              ...
              <div class="space-y-3">
                ...
                <p class="text-sm text-gray-500 flex items-center space-x-2">
                  ...
                  <span>Em: {{ folderName || 'Pasta Desconhecida' }}</span>
                </p>
              ...
              <div class="bg-gray-50 rounded-xl p-4">
                ...
                <p class="text-xs text-gray-500 mt-2">
                  {{ completedSubtasks }} de {{ task.maxSubtasks }} microtarefas concluídas
                </p>
              </div>
              ...
              <div>
                <h4 class="text-xl font-semibold text-gray-700 mb-3 flex items-center space-x-2">
                  ...
                  <span>Microtarefas ({{ completedSubtasks }}/{{ task.maxSubtasks }})</span>
                </h4>
